...
namespace Jagoron.Web
{
    ...
    {
        #region "Insert"
        public static string gInsertPromotionalRequisitionMaster(string VstrRefNo,
                                     string VstrDate,
                                     string vstrBranchID,
                                     string VstrLedgerName,
                                     int intSetId,
                                     string strAttentionLedger,
                                    ...
                                    )
        {
            ...
            strSQL = "INSERT INTO INV_PROMTIONAL_REQUISITION_MASTER ";
            ...
            if (strAttentionLedger != "")
            {
                strSQL = strSQL + ",ATTENTION_LEDGER";
            }
            ...
            strSQL = strSQL + ", NARRATIONS, REQ_STATUS, NET_TOTAL, TOTLA_QTY, INV_VOUCHER_TYPE ";
            if (VstrInvLog != "")
            {
                strSQL = strSQL + ",INV_LOG_NO";
            }
            strSQL = strSQL + ",DEP_WISE_REQ_STATUS,PREPARED_BY,H_F_STATUS,MAP_STATUS";
            strSQL = strSQL + ") ";
            ...
            if (strAttentionLedger != "")
            {
                strSQL = strSQL + "'" + strAttentionLedger + "',";
            }
            ...
            strSQL = strSQL + "," + intDepartmentReqStatus + "";
            strSQL = strSQL + ",'" + strPreparedby.Replace("'", "''") + "'";
            strSQL = strSQL + "," + intH_F + "";
            strSQL = strSQL + "," + intMepingItem + "";
            strSQL = strSQL + ")";
            return strSQL;
        }


        public static string gInsertInvPromotionalReqisitionChild(
                                                  string vstrRefNo,
                                                  string vstrItemName,
                                                  double vdblQty,
                                                  double dblRate,
                                                  ...
                                                  double vdblTotalAmount)
        {
            ...
            string strSQL = "";
            strSQL = "INSERT INTO INV_PROMTIONAL_REQUISITION_CHILD";
                                                       ...
                                                       )
        {
            ...
            strSQL = strSQL + ",DEP_WISE_REQ_STATUS,PREPARED_BY,H_F_STATUS";
            strSQL = strSQL + ") ";
            strSQL = strSQL + "VALUES (";
            strSQL = strSQL + "'" + VstrRefNo + "',";
            strSQL = strSQL + "" + Utility.cvtSQLDateString(VstrDate) + ",";
                                                        ...
                                                        int intvType = 13)
        {
            ...
            //if (vlngVType != (long)Utility.VOUCHER_TYPE.vtSALES_CHALLAN)
            //{
            strSQL = strSQL + " " + -1 * vdblBillRate * Math.Abs(vdblQuantity) + ",";//    'Cost Amount
            //}
            //else
            //{
            //    strSQL = strSQL + "0,";
        ...
        public static string mInsertTranOutward(string vstrLedgerName,
                                                string vstrInvKey,
                                                long vlngLoop,
                                                string vstrRefNo,
                                                string vstrItemName,
                                                ...
                                                int intConverType = 0, string vstrToGodownsName = "")
        {
            ...
            strSQL = "INSERT INTO INV_TRAN";
            strSQL = strSQL + "(LEDGER_NAME,INV_TRAN_KEY,INV_TRAN_POSITION,INV_REF_NO,STOCKITEM_NAME,INV_VOUCHER_TYPE,INV_DATE,";
